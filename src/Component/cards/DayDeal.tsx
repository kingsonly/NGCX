      ...
      <div className='-mt-32 flex flex-col justify-center'>
        <ul className='flex'>
          <li className='rounded-md p-2 bg-white flex justify-center items-center flex-col mr-3 h-16 w-16'>
            <span className='text-green text-2xl mb-0 pb-0 font-medium'>05</span>
            <span className='text-lightgray text-sm' >Days</span>
          </li>
          <li className='rounded-md p-2 bg-white flex justify-center items-center flex-col mr-3 h-16 w-16'>
            <p className='text-green text-2xl mb-0 pb-0 font-medium'>05</p>
            <span className='text-lightgray text-sm' >Hours</span>
          </li>
          <li className='rounded-md p-2 bg-white flex justify-center items-center flex-col mr-3 h-16 w-16'>
            <p className='text-green text-2xl mb-0 pb-0 font-medium'>05</p>
            <span className='text-lightgray text-sm' >Mins</span>
          </li>
          <li className='rounded-md p-2 bg-white flex justify-center items-center flex-col h-16 w-16'>
            <p className='text-green text-2xl mb-0 pb-0 font-medium'>05</p>
            <span className='text-lightgray text-sm' >Sec</span>
          </li>
        </ul>

        <div className='mt-2 bg-white rounded-md p-5 shadow' >
          <p className='font-bold text-sm text-gray mb-3'>LPG</p>
          ...
          <div className='mb-5'>
            <div className='flex items-center'>
              ...
              <span className='ml-4 text-lightgray text-xs' >(4.0)</span>
            </div>
            <p className='text-lightgray text-xs mt-1'>5kg</p>
          </div>
